...
void ProjectVertices(const std::vector<b2Vec2> &vertices, const b2Vec2 &axis,
                     float &min, float &max) {
...
void ProjectCircle(const Circle &circle, const b2Vec2 &axis, float &min,
                   float &max) {
...
b2Vec2 GetClosestPointOnEdge(const b2Vec2 &point, const b2Vec2 &edgeStart,
                             const b2Vec2 &edgeEnd) {
